...
void Polygon::Polygon::resize(void)
{
    if (_v == NULL)
        _size = 0;
      else {
...
Point Polygon::Polygon::point(void)
{
    return _v->point();
}

Edge Polygon::Polygon::edge(void)
{
    return Edge (point(), _v->cw()->point());
}

Vertex *Polygon::Polygon::cw(void)
{
    return _v->cw();
}

Vertex *Polygon::Polygon::ccw(void)
{
    return _v->ccw();
}

Vertex *Polygon::Polygon::neighbor(int rotation)
{
    return _v->neighbor(rotation);
}

Vertex *Polygon::Polygon::advance(int rotation)
{
    return _v = _v->neighbor(rotation);
}

Vertex *Polygon::Polygon::setV(Vertex *v)
{
    return _v = v;
}

Vertex *Polygon::Polygon::insert(Point &p)
{
    if (_size++ == 0)
        _v = new Vertex(p);
      else
...
void Polygon::Polygon::remove(void)
{
    Vertex *v = _v;
...
Polygon *Polygon::Polygon::split(Vertex *b)
{
